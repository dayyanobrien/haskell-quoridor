...
-}
--canMove and validStep and validSteps
--canmove needed to check where player is, validstep used to detect if a wall has been placed (check if edge is available and jumping over walls), make sure you generate extra moves
